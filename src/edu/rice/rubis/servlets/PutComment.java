...
import edu.rice.rubis.SB_PutComment;
...
public class PutComment extends HttpServlet
{
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    try 
    {
      sb_PutComment = (SB_PutComment)PortableRemoteObject.narrow(initialContext.lookup("SB_PutCommentBean"), SB_PutComment.class);
    }
    catch (Exception e)
    {
