...
import edu.rice.rubis.SB_PutBid;
...
public class PutBid extends HttpServlet
{
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    try 
    {
      putBid = (SB_PutBid)PortableRemoteObject.narrow(initialContext.lookup("SB_PutBidBean"), SB_PutBid.class);
    } 
    catch (Exception e)
    {
      printError("Cannot lookup SB_PutBid: " +e+"<br>", sp);
      return ;
    }
   try
    {
