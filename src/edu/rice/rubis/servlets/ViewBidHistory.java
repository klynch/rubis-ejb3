...
import edu.rice.rubis.SB_ViewBidHistory;
...
public class ViewBidHistory extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    else
    {
      ...
      try 
      {
        viewBid = (SB_ViewBidHistory)PortableRemoteObject.narrow(initialContext.lookup("SB_ViewBidHistoryBean"), SB_ViewBidHistory.class);
      } 
      catch (Exception e)
      {
